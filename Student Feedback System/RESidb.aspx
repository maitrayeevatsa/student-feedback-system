<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RESidb.aspx.cs" Inherits="Default2" %>
        ...
        <tr>
            <td class="style7" style="text-align: center">
                <asp:Label ID="Label4" runat="server" style="text-align: center" 
                    Text="Suggestion (Residence)" CssClass="heading"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
        </tr>
            ...
            <td class="style7">
                ...
                <ItemTemplate>
                     <tr style="background-color:#EBEFF0;border-top:1px dotted #df5015; width:500px"> 
                       <td>Suggestion:
                         <asp:Label ID="Label2" runat="server" Text='<%#Eval("resisuggestion") %>' Font-Bold="true"></asp:Label>
                       </td>
                     </tr>
                     <tr>
                       <td>
